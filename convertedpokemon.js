{
	deltabulbasaur: {
		...
		abilities: {0: "PsychoCall", H: "Regenerator"},
		heightm: ".7",
		weightkg: "6.9",
		color: "Green",
	...
	deltaivysaur: {
		...
		abilities: {0: "PsychoCall", 1: "", H: "Regenerator"},
		heightm: "1",
		weightkg: "13.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltacharmander: {
		...
		abilities: {0: "SpiritCall", H: "DarkAura"},
		heightm: ".6",
		weightkg: "8.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltasquirtle: {
		...
		abilities: {0: "ShadowCall", 1: "", H: "ShadowDance"},
		heightm: "0.5",
		weightkg: "9.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltapawniard: {
		...
		abilities: {0: "Defiant", 1: "Frisk", H: "WindForce"},
		heightm: ".5",
		weightkg: "10.2",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltabisharp: {
		...
		abilities: {0: "Frisk", 1: "Defiant", H: "WindForce"},
		heightm: "1.6",
		weightkg: "70.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaralts: {
		...
		abilities: {0: "LightningRod", 1: "ClearBody", H: "SnowCloak"},
		heightm: "0.4",
		weightkg: "6.6",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltagallade: {
		...
		abilities: {0: "VoltAbsorb", H: "IceBody"},
		heightm: "1.6",
		weightkg: "52.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltasunkern: {
		...
		abilities: {0: "FlameBody", 1: "Analytic", H: "PoisonPoint"},
		heightm: ".3",
		weightkg: "1.8",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltabergmite: {
		...
		abilities: {0: "SolidRock", 1: "BattleArmor", H: "SandStream"},
		heightm: "1.0",
		weightkg: "99.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltascyther: {
		...
		abilities: {0: "Hustle", 1: "IceCleats", H: "SuperLuck"},
		heightm: "1.5",
		weightkg: "56.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltascizor: {
		...
		abilities: {0: "Scrappy", 1: "IceCleats", H: "SuperLuck"},
		heightm: "1.8",
		weightkg: "118",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltascraggy: {
		...
		abilities: {0: "RoughSkin", 1: "Rivalry", H: "AngerPoint"},
		heightm: "0.6",
		weightkg: "11.8",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltacombee: {
		...
		abilities: {0: "Levitate", H: "SpeedBoost"},
		heightm: "0.3",
		weightkg: "11.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltakoffing: {
		...
		abilities: {0: "CloudNine", 1: "Amplifier", H: "VoltAbsorb"},
		heightm: ".6",
		weightkg: "1.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltapurrloin: {
		...
		abilities: {0: "Illusion", 1: "Unnerve", H: "LightningRod"},
		heightm: "0.4",
		weightkg: "10.1",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaphantump: {
		...
		abilities: {0: "SnowWarning", 1: "Overcoat", H: "SnowCloak"},
		heightm: "0.4",
		weightkg: "7.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltasnorunt: {
		...
		abilities: {0: "WhiteSmoke", H: "FlashFire"},
		heightm: "0.7",
		weightkg: "16.8",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaglalie: {
		...
		abilities: {0: "RockHead", H: "FlashFire"},
		heightm: "1.5",
		weightkg: "256.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltafroslass: {
		...
		abilities: {0: "Competitive", H: "FlashFire"},
		heightm: "1.3",
		weightkg: "26.6",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltashinx: {
		...
		abilities: {0: "Sniper", 1: "PoisonTouch", H: "Venomous"},
		heightm: ".5",
		weightkg: "19.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaluxio: {
		...
		abilities: {0: "PoisonTouch", 1: "Sniper", H: "Venomous"},
		heightm: ".9",
		weightkg: "30.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltanoibat: {
		...
		abilities: {0: "Chlorophyll", 1: "NaturalCure", H: "SolarPower"},
		heightm: "0.5",
		weightkg: "8.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltanoivern: {
		...
		abilities: {0: "Chlorophyll", 1: "SolarPower", H: "FlowerGift"},
		heightm: "1.5",
		weightkg: "85",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltabudew: {
		...
		abilities: {0: "ShadowDance", 1: "Heliophobia", H: "InnerFocus"},
		heightm: "0.2",
		weightkg: "1.2",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaroselia: {
		...
		abilities: {0: "ShadowDance", 1: "Heliophobia", H: "Limber"},
		heightm: "0.3",
		weightkg: "2.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltadrifloon: {
		...
		abilities: {0: "FlashFire", 1: "VitalSpirit", H: "NoGuard"},
		heightm: "0.4",
		weightkg: "1.2",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltagrimer: {
		...
		abilities: {0: "SapSipper", H: "WaterAbsorb"},
		heightm: "0.9",
		weightkg: "30.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltamuk: {
		...
		abilities: {0: "SapSipper", 1: "Regurgitation", H: "WaterAbsorb"},
		heightm: "1.2",
		weightkg: "30.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltawooper: {
		...
		abilities: {0: "Pickpocket", 1: "FlashFire", H: "Harvest"},
		heightm: "0.4",
		weightkg: "8.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltamunchlax: {
		...
		abilities: {0: "Overcoat", 1: "ThickFat", H: "Adaptability"},
		heightm: "0.6",
		weightkg: "105.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltamisdreavus: {
		...
		abilities: {0: "MagicGuard", H: "WinterJoy"},
		heightm: "0.7",
		weightkg: "1.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltatyphlosion: {
		...
		genderRatio: {M: "0.5", F: "0.5"},
		baseStats: {hp: "78", atk: "84", def: "78", spa: "109", spd: "85", spe: "100"},
		abilities: {0: "MotorDrive", H: "LightningRod"},
		heightm: "1.7",
		weightkg: "159.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltatreecko: {
		...
		abilities: {0: "InnerFocus", H: "IronFist"},
		heightm: "0.5",
		weightkg: "5.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltablaziken: {
		...
		abilities: {0: "KeenEye", H: "GaleWings"},
		heightm: "1.9",
		weightkg: "52.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltapidgey: {
		...
		abilities: {0: "Intimidate", 1: "EarlyBird", H: "MarvelScale"},
		heightm: "0.3",
		weightkg: "1.8",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltapidgeot: {
		...
		abilities: {0: "Intimidate", 1: "KeenEye", H: "MarvelScale"},
		heightm: "1.5",
		weightkg: "39.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltadiglett: {
		...
		abilities: {0: "SnowCloak", 1: "IceCleats", H: "FurCoat"},
		heightm: "0.2",
		weightkg: "0.8",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltagrowlithe: {
		...
		abilities: {0: "InnerFocus", 1: "Intimidate", H: "Multiscale"},
		heightm: "0.7",
		weightkg: "19.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltageodude: {
		...
		abilities: {0: "Regenerator", 1: "SapSipper", H: "MagicBounce"},
		heightm: "0.4",
		weightkg: "20.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltatentacool: {
		...
		abilities: {0: "Regenerator", 1: "PoisonTouch", H: "Overgrow"},
		heightm: "0.9",
		weightkg: "45.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltadoduo: {
		...
		abilities: {0: "Compoundeyes", 1: "Trace", H: "PsychoCall"},
		heightm: "1.4",
		weightkg: "39.2",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltatangela: {
		...
		abilities: {0: "DrySkin", 1: "SandForce", H: "RoughSkin"},
		heightm: "1.0",
		weightkg: "35.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltakabuto: {
		...
		abilities: {0: "Swarm", 1: "Unnerve", H: "ToughClaws"},
		heightm: "0.5",
		weightkg: "11.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltadratini: {
		...
		abilities: {0: "SwiftSwim", H: "VoltAbsorb"},
		heightm: "1.8",
		weightkg: "3.3",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltahoothoot: {
		...
		abilities: {0: "SnowCloak", 1: "KeenEye", H: "NoGuard"},
		heightm: "0.7",
		weightkg: "21.2",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltachinchou: {
		...
		abilities: {0: "FlashFire", 1: "Illuminate", H: "Levitate"},
		heightm: "0.5",
		weightkg: "12.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltapichu: {
		...
		abilities: {0: "CuteCharm", 1: "CloudNine", H: "GaleWings"},
		heightm: "0.3",
		weightkg: "2.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaaipom: {
		...
		abilities: {0: "CursedBody", 1: "Rattled", H: "Technician"},
		heightm: "0.8",
		weightkg: "11.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaambipom: {
		...
		abilities: {0: "CursedBody", 1: "Infiltrator", H: "Technician"},
		heightm: "1.2",
		weightkg: "20.3",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltayanma: {
		...
		abilities: {0: "Adaptability", 1: "LeafGuard", H: "NaturalCure"},
		heightm: "1.2",
		weightkg: "38.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltayanmega: {
		...
		abilities: {0: "Adaptability", 1: "Chlorophyll", H: "NaturalCure"},
		heightm: "1.9",
		weightkg: "51.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltagirafarig: {
		...
		abilities: {0: "AngerPoint", 1: "Stench", H: "Intimidate"},
		heightm: "1.5",
		weightkg: "41.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltadunsparce: {
		...
		abilities: {0: "HyperCutter", 1: "SwiftSwim", H: "SkillLink"},
		heightm: "1.5",
		weightkg: "14.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltashuckle: {
		...
		abilities: {0: "Sturdy", 1: "NoGuard", H: "IronBarbs"},
		heightm: "0.6",
		weightkg: "20.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaremoraid: {
		...
		abilities: {0: "Heatproof", 1: "WhiteSmoke", H: "Contrary"},
		heightm: "0.6",
		weightkg: "12.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaelekid: {
		...
		abilities: {0: "InnerFocus", H: "BattleArmor"},
		heightm: "0.6",
		weightkg: "23.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaelectivire: {
		...
		abilities: {0: "ShadowDance", H: "Sturdy"},
		heightm: "1.8",
		weightkg: "138.6",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltamagmortar: {
		...
		abilities: {0: "MegaLauncher", H: "Filter"},
		heightm: "1.6",
		weightkg: "68.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltalotad: {
		...
		abilities: {0: "MagicBounce", 1: "Synchronize", H: "Unaware"},
		heightm: "0.5",
		weightkg: "2.6",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaseedot: {
		...
		abilities: {0: "VoltAbsorb", 1: "Minus", H: "Competitive"},
		heightm: "0.5",
		weightkg: "4.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltasableye: {
		...
		abilities: {0: "SolidRock", 1: "WeakArmor", H: "Unburden"},
		heightm: "0.5",
		weightkg: "11.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltamawile: {
		...
		abilities: {0: "SereneGrace", 1: "AromaVeil", H: "Immunity"},
		heightm: "0.6",
		weightkg: "11.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaaron: {
		...
		abilities: {0: "FlameBody", 1: "Drought", H: "HeavyMetal"},
		heightm: "0.4",
		weightkg: "60.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltameditite: {
		...
		abilities: {0: "SapSipper", H: "Athenian"},
		heightm: "0.6",
		weightkg: "11.2",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltanumel: {
		...
		abilities: {0: "Venomous", 1: "PoisonPoint", H: "LiquidOoze"},
		heightm: "0.7",
		weightkg: "24.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltawailmer: {
		...
		abilities: {0: "WonderSkin", 1: "Refrigerate", H: "SnowCloak"},
		heightm: "2.0",
		weightkg: "130.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltawailord: {
		...
		abilities: {0: "WonderSkin", 1: "Refrigerate", H: "SnowWarning"},
		heightm: "14.5",
		weightkg: "398.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltafeebas: {
		...
		abilities: {0: "Rattled", 1: "RunAway", H: "SpiritCall"},
		heightm: "0.6",
		weightkg: "7.4",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltamilotic: {
		...
		abilities: {0: "Regenerator", 1: "Defiant", H: "CursedBody"},
		heightm: "6.2",
		weightkg: "162.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaclamperl: {
		...
		abilities: {0: "Pressure", H: "BattleArmor"},
		heightm: "0.40",
		weightkg: "52.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltahuntail: {
		...
		abilities: {0: "Pressure", H: "StrongJaws"},
		heightm: "1.70",
		weightkg: "27.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltagorebyss: {
		...
		abilities: {0: "Pressure", H: "MarvelScale"},
		heightm: "1.80",
		weightkg: "22.6",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltabeldum(spider): {
		...
		abilities: {0: "PoisonTouch", 1: "Immunity", H: "PoisonHeal"},
		heightm: "0.6",
		weightkg: "47.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltalopunny: {
		...
		abilities: {0: "Unburden", 1: "InnerFocus", H: "Limber"},
		heightm: "1.2",
		weightkg: "33.3",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltacroagunk: {
		...
		abilities: {0: "MagmaArmor", 1: "Blaze", H: "Hustle"},
		heightm: "0.7",
		weightkg: "23.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltavenipede: {
		...
		abilities: {0: "WeakArmor", 1: "MagmaArmor", H: "MoldBreaker"},
		heightm: "0.4",
		weightkg: "5.3",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltapetilil(water): {
		...
		abilities: {0: "StormDrain", 1: "FlashFire", H: "Regenerator"},
		heightm: "0.5",
		weightkg: "6.6",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltapetilil(fairy): {
		...
		genderRatio: {M: "0.5", F: "0.5"},
		baseStats: {hp: "45", atk: "35", def: "50", spa: "70", spd: "50", spe: "30"},
		abilities: {0: "SereneGrace", 1: "Synchronize", H: "Healer"},
		heightm: ".508",
		weightkg: "6.62",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltasolosis: {
		...
		abilities: {0: "Levitate", 1: "CursedBody", H: "Intimidate"},
		heightm: "0.3",
		weightkg: "1.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltadarumaka: {
		...
		abilities: {0: "Unnerve", H: "WonderSkin"},
		heightm: "0.6",
		weightkg: "37.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltamaractus: {
		...
		abilities: {0: "MotorDrive", 1: "ClearBody", H: "Trace"},
		heightm: "1.0",
		weightkg: "28.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltadwebble(berry): {
		...
		abilities: {0: "Harvest", 1: "LeafGuard", H: "Chlorophyll"},
		heightm: "0.3",
		weightkg: "14.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltadwebble(cake): {
		...
		genderRatio: {M: "0.5", F: "0.5"},
		baseStats: {hp: "50", atk: "65", def: "85", spa: "35", spd: "35", spe: "55"},
		abilities: {0: "OwnTempo", 1: "Scrappy", H: "Simple"},
		heightm: "0.3",
		weightkg: "14.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltayamask: {
		...
		abilities: {0: "Aftermath", 1: "Infiltrator", H: "WonderSkin"},
		heightm: "0.5",
		weightkg: "1.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaemolga: {
		...
		abilities: {0: "FlashFire", H: "BlazeBoost"},
		heightm: "0.4",
		weightkg: "5.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltakarrablast: {
		...
		abilities: {0: "Gluttony", 1: "SweetVeil", H: "Simple"},
		heightm: "0.5",
		weightkg: "5.9",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltalitwick: {
		...
		abilities: {0: "FlashFire", 1: "WeakArmor", H: "FairyAura"},
		heightm: "0.3",
		weightkg: "3.1",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaaxew: {
		...
		abilities: {0: "StrongJaw", 1: "WaterVeil", H: "SwiftSwim"},
		heightm: "0.6",
		weightkg: "18.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltahaxorus: {
		...
		abilities: {0: "StrongJaw", 1: "WaterVeil", H: "HeavyMetal"},
		heightm: "1.8",
		weightkg: "105.5",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltagolett: {
		...
		abilities: {0: "IronFist", 1: "BattleArmor", H: "Guts"},
		heightm: "1.0",
		weightkg: "92.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaheatmor: {
		...
		abilities: {0: "LiquidOoze", 1: "SheerForce", H: "MegaLauncher"},
		heightm: "1.40",
		weightkg: "116.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaamaura: {
		...
		abilities: {0: "FriendGuard", H: "Phototroph"},
		heightm: "1.3",
		weightkg: "25.2",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltagoomy: {
		...
		abilities: {0: "Overcoat", 1: "WaterAbsorb", H: "Gooey"},
		heightm: "0.3",
		weightkg: "2.8",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaregirock: {
		...
		abilities: {0: "SandVeil", H: "DrySkin"},
		heightm: "1.7",
		weightkg: "230.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaregice: {
		...
		abilities: {0: "WaterVeil", H: "StormDrain"},
		heightm: "1.8",
		weightkg: "175.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
	...
	deltaregisteel: {
		...
		abilities: {0: "FlameBody", H: "Foundry"},
		heightm: "1.9",
		weightkg: "205.0",
		color: "Green",
		eggGroups: ['Undiscovered'],
